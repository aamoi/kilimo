...
public class SharedUtilities {
    ...
    public static EditText getEditTextById(View view, int id){return (EditText)view.findViewById(id);}
    public static Spinner getSpinnerById(View view, int id){return (Spinner)view.findViewById(id);}
    public static Button getButtonById(View view, int id){return (Button) view.findViewById(id);}
